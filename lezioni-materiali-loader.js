(() => {
  ...
  function start() {
    ...
    style.textContent = `
      ...
      .lm-notebook-shell{position:absolute;inset:0 0 62px;display:flex;align-items:center;justify-content:center;padding:0 28px}
      .lm-page{position:relative;width:min(710px,72vw,calc((100dvh - 165px)*.82));height:auto;max-width:none;max-height:calc(100dvh - 165px);aspect-ratio:.82;background:#fff;box-shadow:0 10px 28px rgba(55,60,70,.17);border-radius:10px;overflow:hidden;touch-action:none}
