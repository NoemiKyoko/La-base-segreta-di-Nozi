(() => {
  ...
  function start() {
    ...
    // Andika: caricato come stylesheet vero nel <head>. Su Safari/iPad è più
    // affidabile dell\'@import dentro uno <style> creato dinamicamente.
    if (!document.getElementById("lm-andika-font")) {
      const andikaLink = document.createElement("link");
      andikaLink.id = "lm-andika-font";
      andikaLink.rel = "stylesheet";
      andikaLink.href = "https://fonts.googleapis.com/css2?family=Andika:wght@400;700&display=swap";
      document.head.appendChild(andikaLink);
    }
