(() => {
  ...
  function start() {
    ...
    style.textContent = `
      @font-face{font-family:"Andika";src:url("assets/Andika-Regular.woff2") format("woff2");font-weight:400;font-style:normal;font-display:swap}
...
.lm-page-object.text.andika{font-family:"Andika",Arial,sans-serif!important;font-feature-settings:"ss13" 1,"ss14" 0,"cv10" 0,"cv01" 1,"cv04" 1,"cv06" 1,"cv07" 1,"cv09" 1!important;-webkit-font-feature-settings:"ss13" 1,"ss14" 0,"cv10" 0,"cv01" 1,"cv04" 1,"cv06" 1,"cv07" 1,"cv09" 1!important;font-variant-ligatures:normal}.lm-page-object img{display:block;width:100%;height:100%;object-fit:contain;pointer-events:none;-webkit-user-drag:none}.lm-page-object.file{display:flex;align-items:center;gap:8px;padding:9px 12px;border-radius:10px;background:#fffaf4;color:#444;box-shadow:0 3px 10px rgba(0,0,0,.07)}
...
.lm-page-object.text.andika .lm-native-text-editor{font-family:"Andika",Arial,sans-serif!important;font-feature-settings:"ss13" 1,"ss14" 0,"cv10" 0,"cv01" 1,"cv04" 1,"cv06" 1,"cv07" 1,"cv09" 1!important;-webkit-font-feature-settings:"ss13" 1,"ss14" 0,"cv10" 0,"cv01" 1,"cv04" 1,"cv06" 1,"cv07" 1,"cv09" 1!important}
...
`;
    ...
    function makePageObjectElement(obj, layer) {
      ...
      if (obj.type === "text") {
        ...
        if ((obj.fontFamily || "").includes("Andika")) { el.classList.add("andika"); el.style.fontFeatureSettings='"ss13" 1,"ss14" 0,"cv10" 0,"cv01" 1,"cv04" 1,"cv06" 1,"cv07" 1,"cv09" 1'; }
