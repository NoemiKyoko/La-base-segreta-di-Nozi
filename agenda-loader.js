(() => {
  ...
  function boot(){
    ...
    const st=document.createElement("style");st.textContent=`
      .agenda-screen{position:fixed;inset:0;width:100vw;height:100dvh;z-index:990;display:none;background:linear-gradient(180deg,#eaf3fb,#f7f2fb);overflow:hidden;contain:layout paint}.agenda-screen.aperto{display:block}
      ...
      .agenda-back{position:absolute;left:max(18px,env(safe-area-inset-left));top:max(18px,env(safe-area-inset-top));z-index:1002;width:52px;height:52px;border:0;border-radius:17px;background:rgba(255,255,255,.9);color:#315d91;font-size:31px;box-shadow:0 5px 16px rgba(65,55,90,.14)}
      .agenda-tools{position:absolute;left:max(18px,env(safe-area-inset-left));bottom:max(18px,env(safe-area-inset-bottom));z-index:1003;display:flex;align-items:center;gap:1px;padding:6px 7px 6px 22px;border:1.25px solid #b8d8ec;border-radius:17px;background:#edf6fb;box-shadow:0 5px 14px rgba(65,55,90,.13);touch-action:none}.agenda-grip{position:absolute;left:5px;top:50%;transform:translateY(-50%);width:16px;height:29px;display:grid;place-items:center;color:#6f8da7;font-weight:900;cursor:grab}.agenda-tool{border:0;width:34px;height:34px;border-radius:9px;background:transparent;color:#315d91;font-size:17px;font-weight:800}.agenda-tool.active{background:#fff;box-shadow:0 2px 7px rgba(45,50,60,.09)}.agenda-eraser{display:grid;place-items:center}.agenda-eraser svg{width:19px;height:19px;display:block;overflow:visible}
      .agenda-menu{position:absolute;z-index:1010;display:none;min-width:190px;padding:8px;border:1px solid #c9ddea;border-radius:17px;background:#fffaf7;box-shadow:0 10px 30px rgba(35,45,60,.20)}.agenda-menu.aperto{display:block}.agenda-menu button{border:0;width:100%;padding:11px 13px;border-radius:11px;background:transparent;color:#315d91;text-align:left;font-size:15px;font-weight:750}.agenda-menu .danger{color:#94515d}
      .agenda-zoom{position:absolute;right:max(18px,env(safe-area-inset-right));top:max(18px,env(safe-area-inset-top));z-index:1003;display:flex;gap:4px;padding:6px;border:1.25px solid #b8d8ec;border-radius:17px;background:#edf6fb;box-shadow:0 5px 16px rgba(65,55,90,.13)}.agenda-zoom button{border:0;min-width:48px;height:34px;padding:0 8px;border-radius:10px;background:transparent;color:#315d91;font-size:13px;font-weight:800}.agenda-zoom button.active{background:#fff;box-shadow:0 2px 7px rgba(45,50,60,.09)}
      .agenda-nav{position:absolute;left:50%;bottom:max(18px,env(safe-area-inset-bottom));transform:translateX(-50%);z-index:1003;display:flex;align-items:center;gap:7px;padding:7px 9px;border:1.25px solid #b8d8ec;border-radius:18px;background:#edf6fb;box-shadow:0 5px 16px rgba(65,55,90,.13)}.agenda-nav button{border:0;width:38px;height:38px;border-radius:12px;background:transparent;color:#315d91;font-size:24px}.agenda-nav .agenda-add{background:white;font-size:22px}.agenda-count{min-width:58px;text-align:center;color:#315d91;font-weight:800}
    ...
    window.apriAgenda=()=>{s.classList.add('aperto');panX=0;panY=0;void s.offsetHeight;layoutStage();render()};
