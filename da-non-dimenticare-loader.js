(() => {
  ...
  function start() {
    ...
    style.textContent = `
      ...
      .remember-card{display:grid;grid-template-columns:minmax(180px,.8fr) minmax(300px,1.4fr) 48px;gap:16px 20px;align-items:end;padding:16px;background:rgba(255,255,255,.72);border:2px solid #c8ddec;border-radius:20px}
      ...
      @media(max-width:720px){.remember-workspace{padding:14px 8px}.remember-board{width:96vw;border-width:7px;border-radius:25px;padding:14px}.remember-card{grid-template-columns:1fr 1.35fr 44px;gap:12px}.remember-note{grid-column:1/4;grid-row:2}.remember-delete{grid-column:3;grid-row:1}.remember-title{font-size:22px}.remember-add{padding:0 12px}}
    `;
